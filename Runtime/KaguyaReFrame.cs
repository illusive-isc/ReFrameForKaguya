...
namespace jp.illusive_isc.ReFrame.IKUSIA.Kaguya
{
    ...
    public class KaguyaReFrame : IKUSIACommonReFrame
    {
        ...
        [ReFrameLabel("胸: 小")]
        [ReFrameBlendShape("Body_b", "Breast_small_____胸_小", SceneApply = false)]
        ...
        [ReFrameBlendShape("Body_b", "Breast_big(limit)", SceneApply = false)]
        ...
        [ReFrameBlendShape("Body_b", "Breast_Big_____胸_大(mizuki)", SceneApply = false)]
